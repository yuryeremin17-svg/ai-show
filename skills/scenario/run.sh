...
ВИЗУАЛ: [что видит зритель — место, персонаж, действие, эмоция. Должно читаться БЕЗ голоса!]
ГОЛОС: "[точный текст озвучки в кавычках]"
ЭМОЦИЯ ЗРИТЕЛЯ: [что чувствует зритель — узнавание/удивление/смех/напряжение/задумался]
РИТМ: [быстро/средне/медленно]
MIDJOURNEY: stylized warm illustration, [описание сцены], [персонаж по библии с цветом] --ar 9:16
```
...
- ЭМОЦИЯ ЗРИТЕЛЯ — меняется каждый кадр. Два одинаковых подряд = провал.
...
- Эмоция меняется каждый кадр? ДА/НЕТ
- Ритм не монотонный? ДА/НЕТ
